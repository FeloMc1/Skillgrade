...
// Consultas para obtener puntajes personales y generales de "tecleo"
$sql_personal = "SELECT score, created_at FROM tecleo WHERE user_id = ? ORDER BY score DESC";
$sql_global = "SELECT usuarios.username, tecleo.score, tecleo.created_at 
            FROM tecleo 
            JOIN usuarios ON tecleo.user_id = usuarios.id 
            ORDER BY tecleo.score DESC, tecleo.created_at ASC LIMIT 10";
...
<head>
    ...
    <title>Puntajes de Tecleo - SkillGrade 2.0</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="style2.css">
</head>
<body>
    <div class="container my-5">
        <h2 class="text-center">Puntajes de Tecleo</h2>
