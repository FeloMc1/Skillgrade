...
// Consultas para obtener puntajes personales y generales de "juegos_mentales"
$sql_personal = "SELECT score, date FROM juegos_mentales WHERE user_id = ? ORDER BY score DESC";
$sql_global = "SELECT usuarios.username, juegos_mentales.score, juegos_mentales.date 
               FROM juegos_mentales 
               JOIN usuarios ON juegos_mentales.user_id = usuarios.id 
               ORDER BY juegos_mentales.score DESC, juegos_mentales.date ASC LIMIT 10";
...
<head>
    ...
    <title>Puntajes de Juegos Mentales - SkillGrade 2.0</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="style2.css">
</head>
<body>
    <div class="container my-5">
        <h2 class="text-center">Puntajes de Juegos Mentales</h2>
