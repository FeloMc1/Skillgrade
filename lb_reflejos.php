...
// Consultas para obtener puntajes personales y generales de "reflejos"
$sql_personal = "SELECT score, date FROM reflejos WHERE user_id = ? ORDER BY score DESC";
$sql_global = "SELECT usuarios.username, reflejos.score, reflejos.date 
               FROM reflejos 
               JOIN usuarios ON reflejos.user_id = usuarios.id 
               ORDER BY reflejos.score DESC, reflejos.date ASC LIMIT 10";
...
<head>
    ...
    <title>Puntajes de Reflejos - SkillGrade 2.0</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="style2.css">
</head>
<body>
    <div class="container my-5">
        <h2 class="text-center">Puntajes de Reflejos</h2>
