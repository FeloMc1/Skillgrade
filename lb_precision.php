...
// Consultas para obtener puntajes personales y generales de "precis"
$sql_personal = "SELECT score, date FROM precis WHERE user_id = ? ORDER BY score DESC";
$sql_global = "SELECT usuarios.username, precis.score, precis.date 
               FROM precis 
...
<head>
    ...
    <title>Puntajes de Precisión - SkillGrade 2.0</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="style2.css">
</head>
<body>
    <div class="container my-5">
        <h2 class="text-center">Puntajes de Precisión</h2>
